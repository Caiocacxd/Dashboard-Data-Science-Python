...
df = pd.read_csv("dataframe-tratado.csv")
...
st.markdown('Explore os dados salarias na área de dados nos últimos anos. Utilize os filtros à esquerda para refinar sua análise.')
...
col1.metric('Salário máximo', f'{salario_maximo:,.0f}')
